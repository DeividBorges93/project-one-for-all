...
O projeto ***One For All***, usa **uma** tabela para revisar e consolidar **todos** os principais conceitos vistos.
...
- Como o processo de normalizar os arquivos e tabelas antes de criar o banco nos ajuda lá na frente, tendo um banco mais consistente e escalável, além de reduzir erros, dados repetidos e nos garantem dados mais integros. Referente as funções e aos JOINs, nos agilizam muito nas criações das query e nos dão novas possibilidades de criação.

## Novas habilidades adquiridas através do projeto

- Normalizar um banco de dados seguindo as 3 formas normais;
